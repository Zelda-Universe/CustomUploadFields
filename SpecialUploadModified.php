<?php
/**
 * Modification by Abdullah of Zelda Wiki
 * Original version: 1.21.1
 * 
 * This is an exact copy of includes/special/SpecialUpload.php, with one major difference.
 *	The function "getInitial" has been replaced with the following:
 
	public static function getInitialPageText( $comment = '', $license = '', $copyStatus = '', $source = '' ) {
		return $license;
	}

 * This page will override the default Special:Upload page.
 * It is intended to be used with CustomUploadFields, which passes its output as $mLicense
 */
